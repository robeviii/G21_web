                ...
                <tbody>
                    ...
                    <c:forEach var="alumno" items="${lista}">
                        <tr>
                            ...
                            <td><a href="ControladorTutor?accion=darnota&idalumno=<c:out value="${alumno.id}" />">Dar nota</a></td>
                            <td><a href="ControladorTutor?accion=escribirinforme&idalumno=<c:out value="${alumno.id}" />">Escribir informe</a></td>
